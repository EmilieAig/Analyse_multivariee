...
plot_cercle_pls <- function(correlations, comp1, comp2, Xvar) {
  ...
  plot(0, 0, xlim = c(-1, 1), ylim = c(-1, 1),
       ...
       main = paste("Cercle de corrélation PLS - Composantes", comp1, "-", comp2),
       type = "n", asp = 1)
...
abline(v = log(lambda_optimal_ridge), col = "purple", lty = 2, lwd = 2)
abline(v = log(lambda_1se_ridge), col = "blue3", lty = 2, lwd = 2)
legend("topright", 
...
plot(cv_ridge, col = "black", main = "Validation croisée Ridge", type = "l")
abline(v = log(lambda_optimal_ridge), col = "purple", lty = 2, lwd = 2)
abline(v = log(lambda_1se_ridge), col = "blue3", lty = 2, lwd = 2)
legend("topright", 
       legend = c("lambda_min", "lambda_1se"),
...
plot(Y_vector, Y_pred_lasso,
     ...
     pch = 20,
     col = rgb(1.0, 0.55, 0.75, 0.5))

abline(a = 0, b = 1, col = "red", lwd = 2)
abline(lm(Y_pred_lasso ~ Y_vector), col = "pink3", lty = 2, lwd = 2)
...
couleur_rcp_globale <- rgb(0.0, 0.6, 0.4, 0.5)    # Vert
...
couleur_lasso <- rgb(1.0, 0.55, 0.75, 0.5)        # Rose

# 1. RCP globale (avec transformation log)
png("graph_RCP_globale.png", width = largeur, height = hauteur, res = resolution)
plot(treedensity_log, fitted(modele_log), 
     ...
     cex.lab = 1.1)
abline(a = 0, b = 1, col = "red", lwd = 2)
abline(lm(fitted(modele_log) ~ treedensity_log), col = "green3", lty = 2, lwd = 2)
legend("topleft",
       legend = c("Droite identité (y=x)", "Droite de régression"),
       col = c("red", "green3"),
       lty = c(1, 2),
